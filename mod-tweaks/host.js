...
$('document').ready(function() {
    ...
    ws.onmessage = function (evt) {
        ...
        if (cmd == "pedalboard_name") {
            // Gap D: server pushes the loaded pedalboard's name (may contain
            // spaces; `data` preserves them). The loading_end message that
            // immediately follows redraws the title bar using desktop.title.
            desktop.title = data
            return
        }
